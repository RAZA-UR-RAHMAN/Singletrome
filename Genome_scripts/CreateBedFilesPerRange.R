# could not run here because of the genomic ranges version. Struggles for hours to update but do not have persmissions (27.12.2021)
# Ran on local system by accessing the remote dirs. Changed the paths with /Volumes/Mullen/Raza/ in the local machine.
